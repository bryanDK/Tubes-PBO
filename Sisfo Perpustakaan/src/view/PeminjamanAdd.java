 ...
 * @author Rizky
 */
public class PeminjamanAdd extends javax.swing.JFrame {
  ...
  public long gettIdPeminjaman() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeminjamanAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PeminjamanAdd().setVisible(true);
            }
        });
    }
